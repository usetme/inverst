<template>
  <div class="addproduct">
    <group>
      <popup-picker title="*选择分类" :data="list1" v-model="value"></popup-picker>
    ...
    <flexbox style="margin-top:30px">
      <flexbox-item>
        <div class="flex-demo">
          <x-button type="primary" @click.native="back" style="width: 150px">返回</x-button>
        </div>
      </flexbox-item>
      <flexbox-item>
        <div class="flex-demo">
          <x-button type="primary" @click.native="save" style="width: 150px">保存</x-button>
        </div>
      </flexbox-item>
    </flexbox>
  </div>
